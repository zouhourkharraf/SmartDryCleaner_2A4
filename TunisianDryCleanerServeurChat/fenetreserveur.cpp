...
FenetreServeur::FenetreServeur()
{
    ...
    setWindowTitle(tr("Serveur TunisianDryCleaner"));
...
void FenetreServeur::nouvelleConnexion()
{
    envoyerATous(tr("<em><font color=red>Un nouveau employé vient de se connecter</font></em>"));
...
void FenetreServeur::donneesRecues()
{
...
void FenetreServeur::deconnexionClient()
{
    envoyerATous(tr("<em><font color=red>Un employé vient de se déconnecter</font></em>"));
...
void FenetreServeur::envoyerATous(const QString &message)
{
