...
int statistique::Statistique_partie2()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from CLIENTS where ADRESSE_CLIENT = 'Bizerte'") ;
    while(requete.next())
    {
            count++ ;
    }
...
int statistique::Statistique_partie3()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from CLIENTS where ADRESSE_CLIENT = 'Tunis'") ;
    while(requete.next())
    {
            count++ ;
    }
...
int statistique::Statistique_partie4()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from CLIENTS where ADRESSE_CLIENT = 'Nabeul'") ;
    while(requete.next())
    {
            count++ ;
    }
...
int statistique::Statistique_partie5()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from CLIENTS where ADRESSE_CLIENT= 'Sfax'") ;
    while(requete.next())
    {
            count++ ;
    }
...
int statistique::Statistique_partie6()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from CLIENTS where ADRESSE_CLIENT = 'Sousse' ") ;
    while(requete.next())
    {
            count++ ;
    }
