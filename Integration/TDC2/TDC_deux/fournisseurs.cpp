...
int fournisseurs:: getid_f()
{
    ...
    bool fournisseurs::supprimer_fournisseur(int id)
    {
         QSqlQuery query;
 ...
 bool  fournisseurs::modifier_fournisseur(int id_f,QString nom_f,QString prenom_f,QString adresse_f,QString email_f,int tel_f)
         {
             QSqlQuery query;
...
QSqlQueryModel * fournisseurs::recuperer_fournisseur(int id_f)
      {
         QSqlQueryModel * model = new QSqlQueryModel();
         QString idS = QString::number(id_f);
         model->setQuery("SELECT * FROM fournisseurs WHERE id_f="+idS );
         model->setHeaderData(0,Qt::Horizontal,QObject::tr("id_f"));
         model->setHeaderData(1,Qt::Horizontal,QObject::tr("nom_f"));
         model->setHeaderData(2,Qt::Horizontal,QObject::tr("prenom_f"));
         model->setHeaderData(3,Qt::Horizontal,QObject::tr("adresse_f"));
...
QSqlQueryModel * fournisseurs::trier_fournisseurid()
{
        QSqlQueryModel * model= new QSqlQueryModel();
           model->setQuery("select * from fournisseurs order by id_f");
           model->setHeaderData(0, Qt::Horizontal, QObject::tr("id_f"));
           model->setHeaderData(1, Qt::Horizontal, QObject::tr("nom_f"));
           model->setHeaderData(2, Qt::Horizontal, QObject::tr("prenom_f"));
           model->setHeaderData(3, Qt::Horizontal, QObject::tr("adresse_f"));
...
QSqlQueryModel * fournisseurs::trier_fournisseurnom()
{
        QSqlQueryModel * model= new QSqlQueryModel();
           model->setQuery("select * from fournisseurs order by nom_f");
           model->setHeaderData(0, Qt::Horizontal, QObject::tr("id_f"));
           model->setHeaderData(1, Qt::Horizontal, QObject::tr("nom_f"));
           model->setHeaderData(2, Qt::Horizontal, QObject::tr("prenom_f"));
           model->setHeaderData(3, Qt::Horizontal, QObject::tr("adresse_f"));
...
QSqlQueryModel * fournisseurs::trier_fournisseurtel()
{
        QSqlQueryModel * model= new QSqlQueryModel();
           model->setQuery("select * from fournisseurs order by tel_f");
           model->setHeaderData(0, Qt::Horizontal, QObject::tr("id_f"));
           model->setHeaderData(1, Qt::Horizontal, QObject::tr("nom_f"));
           model->setHeaderData(2, Qt::Horizontal, QObject::tr("prenom_f"));
           model->setHeaderData(3, Qt::Horizontal, QObject::tr("adresse_f"));
