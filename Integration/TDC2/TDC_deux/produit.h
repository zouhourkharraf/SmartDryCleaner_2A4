...
public:
    ...
    bool modifier_produit(int ,int  , QDate   ,int ,QString  , QString ,int );

    QSqlQueryModel * tridesc_produit();
    QSqlQueryModel *  trinom_produit() ;
    QSqlQueryModel *   tridf_produit() ;
    QString  apercu_pdf_produit();
