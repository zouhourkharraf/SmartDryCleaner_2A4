...
bool Produit :: supprimer_produit(int id_prod)
{
   QSqlQuery query ;
 ...
 bool  Produit :: modifier_produit(int id_prod,int prix_achat , QDate date_entree_enstock  ,int qte,QString classification , QString libelle_prod,int id_f)
      {
     ...
     QSqlQueryModel * Produit::  tridesc_produit()
     {
     ...
     QSqlQueryModel * Produit::  trinom_produit()
     {
     ...
     QSqlQueryModel * Produit::  tridf_produit()
     {
     ...
     QString Produit:: apercu_pdf_produit()
           {
